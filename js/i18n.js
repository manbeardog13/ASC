...
const DICT = {
  en: {
    ...
    "login.stageTitle1": "Your tires,", "login.stageTitle2": "in safe hands.",
    "login.stageLead": "Dubrovnik's best car shop. Storage, appointments and swaps — all in one place.",
    "login.stageNotch": "Auto servisni centar · Dubrovnik",
    "login.welcomeBack": "Welcome back", "login.welcomeSub": "Sign in to your ASC account",
    "login.createTitle": "Create your account",
    "login.chipLive": "Tire hotel", "login.chipQr": "QR tracking", "login.chipRem": "Reminders",
    "login.chipSets": "{n} sets in storage", "login.chipDue": "{n} pickups soon", "login.orEmail": "or with email",
    "dash.stageLabel": "STORAGE · TIRE HOTEL", "dash.askAgent": "Ask ASC Agent",
    "dash.occupancy": "Occupancy", "dash.quickActions": "Quick actions", "dash.scanQr": "Scan QR",
    "dash.helloTail": "— all set for the shift.", "dash.capLine": "in storage · {n} reserved",
    "dash.newSet": "Check in a new set", "dash.setsUnit": "sets", "dash.bySeason": "By season",
    ...
    "common.loading": "Loading…", "common.save": "Save", "common.notFound": "Not found", "common.actionFailed": "Action failed",
    ...
    "dash.emptyTitle": "No tires stored yet", "dash.emptyBody": "Check in a customer's set to get started.", "dash.storeTires": "Check in tires",
    ...
    "scan.notAsc": "That's not an ASC sticker. Scan a set's QR label, or type its code (ASC-2026-0042).",
    ...
    "rem.overdue": "Overdue", "rem.dueToday": "Due today", "rem.dueWeek": "This week", "rem.resting": "Already reminded", "rem.summary": "Reminders for today: {n}",
  ...
  hr: {
    ...
    "login.email": "E-mail adresa", "login.password": "Lozinka", "login.signin": "Prijavi se",
    "login.createAccount": "Registrirajte se", "login.haveAccount": "Već imate račun? Prijava",
    ...
    "login.google": "Nastavi s Googleom", "login.firstTime": "Nemate račun?", "login.or": "ili",
    ...
    "login.stageTitle1": "Vaše gume,", "login.stageTitle2": "na sigurnom.",
    "login.stageLead": "Najbolji auto servis u Dubrovniku. Skladište, termini i zamjene — sve na jednom mjestu.",
    "login.stageNotch": "Auto servisni centar · Dubrovnik",
    "login.welcomeBack": "Dobro došli natrag", "login.welcomeSub": "Prijavite se u svoj ASC račun",
    "login.createTitle": "Izradite svoj račun",
    "login.chipLive": "Hotel za gume", "login.chipQr": "QR praćenje", "login.chipRem": "Podsjetnici",
    "login.chipSets": "{n} setova na skladištu", "login.chipDue": "{n} za preuzimanje", "login.orEmail": "ili e-mailom",
    "dash.stageLabel": "SKLADIŠTE · HOTEL ZA GUME", "dash.askAgent": "Pitaj ASC Agenta",
    "dash.occupancy": "Zauzeće", "dash.quickActions": "Brze akcije", "dash.scanQr": "Skeniraj QR",
    "dash.helloTail": "— sve spremno za smjenu.",
    "dash.capLine": "na čuvanju · {n} rezervirano", "dash.newSet": "Zaprimi novi set",
    ...
    "common.loading": "Učitavanje…", "common.save": "Spremi", "common.notFound": "Nije pronađeno", "common.actionFailed": "Radnja nije uspjela",
    "time.now": "upravo sad", "time.min": "prije {n} min", "time.hour": "prije {n} h",
    "dash.search": "Traži ime, registraciju, dimenziju, DOT, lokaciju…",
    "dash.inventory": "Zalihe", "dash.checkedInToday": "Danas zaprimljeno", "dash.pickedUpToday": "Danas preuzeto",
    ...
    "dash.emptyTitle": "Još nema spremljenih guma", "dash.emptyBody": "Zaprimite komplet kupca za početak.", "dash.storeTires": "Zaprimi gume",
    ...
    "scan.notAsc": "To nije ASC naljepnica. Skenirajte QR kompleta ili upišite kôd (ASC-2026-0042).",
    ...
    "rem.overdue": "Kasni", "rem.dueToday": "Danas za preuzimanje", "rem.dueWeek": "Ovaj tjedan", "rem.resting": "Već podsjećeno", "rem.summary": "Podsjetnici za danas: {n}",
