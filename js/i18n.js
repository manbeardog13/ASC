...
const DICT = {
  en: {
    ...
    "dash.helloTail": "— all set for the shift.", "dash.capLine": "sets in storage · {n} reserved",
    "dash.newSet": "New set for storage", "dash.setsUnit": "sets", "dash.bySeason": "By season",
    ...
    "dash.helloTail": "— all set for the shift.",
    "dash.capLine": "sets in storage · {n} reserved", "dash.newSet": "New set for storage",
  ...
  hr: {
    ...
    "dash.capLine": "setova na čuvanju · {n} rezervirano", "dash.newSet": "Novi set na čuvanje",
